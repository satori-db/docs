...
Copy the [Satori.php](https://github.com/satori-db/satori-client/blob/main/src/Satori.php) file to your project and make sure Composer's autoload is configured.
